...
# Remove rows where 'Temperature' is NaN or missing
filtered_data = weather_data.dropna(subset=['Temperature'])
...
pressure_values = filtered_data['Temperature'].values  # Now this contains valid Temperature values only
...
plt.savefig(os.path.join(current_dir, '..', 'assets', 'isotherm_heatmap.png'), dpi=300, bbox_inches='tight', transparent=True, pad_inches=0)
crop_inches = 1
heatmap_path = os.path.join(current_dir, '..', 'assets', 'isotherm_heatmap.png')
...
plt.savefig(os.path.join(current_dir, '..', 'assets', 'isotherms.png'), dpi=300, bbox_inches='tight', transparent=True, pad_inches=0)
crop_inches = 1
isolines_path = os.path.join(current_dir, '..', 'assets', 'isotherms.png')
