...
plt.savefig("isopleths/isotachs.png", dpi=300, bbox_inches='tight', transparent=True, pad_inches=0)

# Usage
image_path = "isopleths/isotachs.png"  # Replace with the path to your image
