...
pressure_values = filtered_data['cloud_cover'].values
...
plt.savefig(os.path.join(current_dir, '..', 'assets', 'isonephs.png'), dpi=300, bbox_inches='tight', transparent=True, pad_inches=0)

# Usage
image_path = os.path.join(current_dir, '..', 'assets', 'isonephs.png')  # Replace with the path to your image
